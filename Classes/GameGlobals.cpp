...
void GameGlobals::ScaleLabel(CCLabelBMFont* label)
{
	// helper function to animate a label
	label->runAction(CCSequence::create(CCScaleTo::create(0.1f, 1.2f), CCScaleTo::create(0.1f, 0.8f), CCScaleTo::create(0.1f, 1.2f), CCScaleTo::create(0.1f, 0.8f), NULL));
}
